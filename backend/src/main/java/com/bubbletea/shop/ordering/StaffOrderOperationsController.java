...
public class StaffOrderOperationsController {
    ...
    @RestControllerAdvice(assignableTypes = {StaffOrderOperationsController.class, CounterOrderController.class, CashFlowController.class, CardCheckoutController.class})
