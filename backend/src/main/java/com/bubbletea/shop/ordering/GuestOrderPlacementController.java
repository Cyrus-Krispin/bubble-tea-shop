...
public class GuestOrderPlacementController {
    ...
    @RestControllerAdvice(assignableTypes = {GuestOrderPlacementController.class, CounterOrderController.class, CustomerFavoriteController.class, CardCheckoutController.class})
    static class Advice {
        @ExceptionHandler({
