...
const authState = vi.hoisted(() => ({
  isLoading: false,
  session: null as null | { accessToken: string; expiresAt: number; email: string },
}));
...
describe("CustomerHeader", () => {
  ...
  it("links signed-in customers to their account from the profile menu", () => {
    authState.session = { accessToken: "customer-token", expiresAt: 4102444800, email: "customer@example.test" };
