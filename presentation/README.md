...
by a silent 51-second product tour and the everyday order example. The tour includes customer
ordering, staff work, recipes, manager access, Supabase tables and users, and Grafana. The workflow and
